...
import 'package:leos_music_shop_flutter/app/modules/drums/drumkit_details_screen.dart';
...
@MaterialAutoRouter(replaceInRouteName: 'Page,Route', routes: <AutoRoute>[
  AutoRoute(name: 'HomeRoute', page: HomeScreen, initial: true),
  AutoRoute(
      name: 'BassDetailsRoute',
      page: BassDetailsScreen,
      path: '/bass_details'),
  AutoRoute(
      name: 'DrumKitDetailsRoute',
      page: DrumKitDetailsScreen,
